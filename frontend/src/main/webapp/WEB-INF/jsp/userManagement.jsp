...
<div class="sidnav">
    ...
    <div class="sidnav-item-conteiner">
        <a href="/userManagement" class="sidnav-item">USER MANAGEMENT</a>
    </div>
    ...
    <table id="regularUserTable" class="table table-striped table-bordered table-sm" width="100%">
        ...
        <c:forEach items="${regularUserInfo}" var="regularUser">
            <tr>
                ...
                <td>
                    <button onclick="/deactivateUser/${regularUser.username}" type="button" class="btn">Deactivate</button>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <table id="businessUserTable" class="table table-striped table-bordered table-sm" width="100%">
        ...
        <c:forEach items="${businessUserInfo}" var="businessUser">
            <tr>
                ...
                <td>
                    <button onclick="/deactivateUser/${businessUser.username}" type="button" class="btn">Deactivate</button>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <table id="adminTable" class="table table-striped table-bordered table-sm" width="100%">
        ...
        <c:forEach items="${adminInfo}" var="adminUser">
            <tr>
                ...
                <td>
                    <button onclick="users/deactivateUser/${adminUser.username}" type="button" class="btn">Deactivate</button>
                </td>
            </tr>
        </c:forEach>
        </tbody>
