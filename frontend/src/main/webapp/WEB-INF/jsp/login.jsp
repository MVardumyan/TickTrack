                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form id="register-form" action="https://phpoll.com/register/process" method="post" role="form" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        <input type="password" name="first name" id="firstName" tabindex="2" class="form-control" placeholder="First Name">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="last name" id="lastName" tabindex="2" class="form-control" placeholder="Last Name">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="last name" id="gender" tabindex="2" class="form-control" placeholder="Gender">
                                    </div>
                                    <div class="form-group">
